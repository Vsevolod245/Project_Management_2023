...
- Добавление услуги в заказ
  - Входные параметры: id услуги.
  - Выходные параметры: id заказа, массив услуг в заказе, где для каждой услуги указаны ее id, название, категория, создатель.
- Получение заказа для пользователя
  - Входные параметры: id заказа.
  - Выходные парамтеры: массив услуг в заказе, где для каждой услуги указаны ее id, название, категория, создатель, дата создания заказа.